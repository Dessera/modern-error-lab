...
\DoxyCodeLine{00014\ \};}
\DoxyCodeLine{00015\ }
\DoxyCodeLine{00016\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ CharT>\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structflex_1_1Error}{flex::Error}}<\mbox{\hyperlink{structExpectedDivideByZeroError}{ExpectedDivideByZeroError}},\ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{CharT}}>\ \{}
\DoxyCodeLine{00017\ \ \ \ \ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{static}\ \textcolor{keyword}{auto}\ output(\textcolor{keyword}{const}\ \mbox{\hyperlink{structExpectedDivideByZeroError}{ExpectedDivideByZeroError}}\ \&\mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{err}},}
\DoxyCodeLine{00018\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{OutputStream<CharT>}}\ \&\mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{out}})}
\DoxyCodeLine{00019\ \ \ \ \ \ \ \ \ -\/>\ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{OutputStream<CharT>}}\ \&\ \{}
\DoxyCodeLine{00020\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{out\ <<\ std::basic\_string\_view<CharT>}}(\textcolor{stringliteral}{"{}Divide\ number\ "{}})\ <<\ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{err}}.dividend}
\DoxyCodeLine{00021\ \ \ \ \ \ \ \ \ \ \ \ \ <<\ std::basic\_string\_view<CharT>(\textcolor{stringliteral}{"{}\ by\ zero"{}});}
\DoxyCodeLine{00022\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{out}};}
\DoxyCodeLine{00023\ \ \ \ \ \}}
\DoxyCodeLine{00024\ \};}
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{using\ }\mbox{\hyperlink{test__flex__perf_8hpp_a354672773be7bc5efd33eb7f8f112332}{ExpectedArithmeticError}}\ =\ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{flex::ErrorGroup<ExpectedDivideByZeroError>}};}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00030\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classExceptionDivideByZeroError}{ExceptionDivideByZeroError}}\ :\ \textcolor{keyword}{public}\ std::exception\ \{}
...
\DoxyCodeLine{00036\ \ \ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classExceptionDivideByZeroError}{ExceptionDivideByZeroError}}(\textcolor{keywordtype}{int}\ dividend);}
\DoxyCodeLine{00037\ }
...
\DoxyCodeLine{00064\ \ \ \ \ -\/>\ \mbox{\hyperlink{flex_8hpp_aa47da71ed3743e9bb242f1fe89d80ac2}{flex::Result<int,\ ExpectedArithmeticError>}};}
\DoxyCodeLine{00065\ }
